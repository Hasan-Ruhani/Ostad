			...
			<div class="row">
				<div class="col">
                    <form method="POST" action="registration.php">
                        ...
                        <div class="input-group"> <p></p><?php echo $inv_first; ?></p> </div>
                        ...
                        <div class="input-group"> <?php echo $inv_last; ?> </div>
                        <div class="input-group form-group">
                            <div class="input-group-prepend">
                        ...
                        <div class="input-group"> <?php echo $inv_email, $inv_email_blank; ?> </div>
						<div class="input-group form-group">
							<div class="input-group-prepend">
                        ...
                        <div class="input-group"> <?php echo $blank_pass; ?> </div>
                        <div class="input-group form-group">
							<div class="input-group-prepend">
                        ...
                        <div class="input-group"> <?php echo $inv_pass; ?> </div>
                        <div class="input-group form-group">
							<div class="input-group-prepend">
                        ...
                        <div class="input-group"> <?php echo $suc_msg; ?> </div>
					</form>
				</div>
			</div>
		</div>
